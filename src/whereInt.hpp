...
** planner logic in "where.cpp".  These definitions are broken out into
...
struct WhereRightJoin {
  ...
  int regReturn;       /* Return for the interior subroutine */
...
struct InLoop {
  ...
  int iBase;             /* Base of multi-key index record */
...
struct WhereLevel {
  ...
  u32 iLikeRepCntr;     /* LIKE range processing counter (times 2) */
...
/*
** Private interfaces - callable only by other where.cpp routines.
**
** where.cpp:
*/
