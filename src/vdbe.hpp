...
/*
** The makefile scans the vdbe.cpp source file and creates the "opcodes.h"
...
** routine in vdbe.cpp, alerting the developer to the missed tag.
**
...
** vdbe.cpp source file for additional information.
*/
#ifdef SQLITE_VDBE_COVERAGE
