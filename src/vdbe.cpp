...
/*
** Test a to see if it exceeds the current maximum blob size.
...
** string that the itself controls.  In other words, it
...
static VdbeCursor *allocateCursor(
  ...
  ** the top of the space.  Cursor 1 is at Mem[p->nMem-1].
  ...
  ** to hold cursors, it is faster to in-line the logic. */
  ...
  if( pMem->szMalloc<nByte ){
    ...
    pMem->z = pMem->zMalloc = static_cast<char*>(sqlite3DbMallocRaw(pMem->db, nByte));
    if( pMem->zMalloc==0 ){
      pMem->szMalloc = 0;
      return 0;
    }
...
#ifdef SQLITE_DEBUG
/*
** Print the value of a for tracing purposes:
*/
...
/*
** Return the of pOp->p2 after first preparing it to be
...
** the code reduces pressure and helps the common case
** to run faster.
*/
static SQLITE_NOINLINE int vdbeColumnFromOverflow(
  ...
  if( len > 4000 && pC->pKeyInfo==0 ){
    ...
    */
    ...
    char *pBuf;
    if( pC->colCache==0 ){
      pC->pCache = static_cast<VdbeTxtBlbCache*>(sqlite3DbMallocZero(db, sizeof(VdbeTxtBlbCache) ));
...
/* Opcode:  Gosub P1 P2 * * *
**
** Write the current address onto P1
...
**
** Jump to the address stored in P1.  If P1 is a return address
** register, then this accomplishes a return from a subroutine.
**
** If P3 is 1, then the jump is only taken if P1 holds an integer
** values, otherwise execution falls through to the next opcode, and the
** OP_Return becomes a no-op. If P3 is 0, then P1 must hold an
** integer or else an assert() is raised.  P3 should be set to 1 when
** this opcode is used in combination with OP_BeginSubrtn, and set to 0
** otherwise.
**
** The value in P1 is unchanged by this opcode.
**
...
**
** Set up P1 so that it will Yield to the coroutine
...
**
** The instruction at the address in P1 is a Yield.
** Jump to the P2 parameter of that Yield.
** After the jump, the value P1 is left with a value
...
/* Opcode:  Yield P1 P2 * * *
**
** Swap the program counter with the value in P1.  This
...
**
** Check the value in P3.  If it is NULL then Halt using
** parameter P1, P2, and P4 as if this were a Halt instruction.  If the
** value in P3 is not NULL, then this routine is a no-op.
...
**
** If P3 is not zero and P4 is NULL, then P3 is a that holds the
...
** Synopsis: r[P2]=P1
**
** The 32-bit integer value P1 is written into P2.
*/
...
**
** The string value P4 of length P1 (bytes) is stored in P2.
**
** If P3 is not zero and the content of P3 is equal to P5, then
** the datatype of the P2 is converted to BLOB.  The content is
...
** return address contains a NULL, the OP_Return instruction is
...
** NULL into P3 and every in between P2 and P3.  If P3
** is less than P2 (typically P3 is zero) then only P2 is
** set to NULL.
**
...
** Synopsis: r[P1]=NULL
**
** Set P1 to have the value NULL as seen by the OP_MakeRecord
...
** blob in P2.  If P4 is a NULL pointer, then construct
...
**
** Transfer the values of bound parameter P1 into P2
*/
...
**
** Move the P3 values in P1..P1+P3-1 over into
** registers P2..P2+P3-1.  Registers P1..P1+P3-1 are
** left holding a NULL.  It is an error for ranges
...
** Synopsis: r[P2]=r[P1]
**
** Make a shallow copy of P1 into P2.
**
...
** Synopsis: r[P2]=r[P1]
**
** Transfer the integer value held in P1 into P2.
**
...
case OP_ResultRow: {
...
#ifdef SQLITE_DEBUG
  {
    ...
    for(i=0; i<pOp->p2; i++){
      ...
      ** the values.  Therefore, we can go ahead and break any
...
**
** Add the text in P1 onto the end of the text in
** P2 and store the result in P3.
** If either the P1 or P2 text are NULL then store NULL in P3.
**
**   P3 = P2 || P1
**
** It is illegal for P1 and P3 to be the same register. Sometimes,
** if P3 is the same as P2, the implementation is able
** to avoid a memcpy().
*/
...
**
** Add the value in P1 to the value in P2
** and store the result in P3.
...
**
**
** Multiply the value in P1 by the value in P2
** and store the result in P3.
** If either input is NULL, the result is NULL.
*/
...
** Synopsis: r[P3]=r[P2]-r[P1]
**
** Subtract the value in P1 from the value in P2
** and store the result in P3.
** If either input is NULL, the result is NULL.
*/
...
** Synopsis: r[P3]=r[P2]/r[P1]
**
** Divide the value in P1 by the value in P2
** and store the result in P3 (P3=P2/P1). If the value in
** P1 is zero, then the result is NULL. If either input is
** NULL, the result is NULL.
*/
/* Opcode: Remainder P1 P2 P3 * *
** Synopsis: r[P3]=r[P2]%r[P1]
**
** Compute the remainder after integer P2 is divided by
** P1 and store the result in P3.
** If the value in P1 is zero the result is NULL.
...
** functions.
**
** If P1 is not zero, then it is a that a subsequent min() or
** max() aggregate will set to 1 if the current row is not the minimum or
** maximum.  The P1 is initialized to 0 by this instruction.
**
...
** Synopsis: r[P3]=r[P1]&r[P2]
**
** Take the bit-wise AND of the values in P1 and P2 and
...
** Synopsis: r[P3]=r[P1]|r[P2]
**
** Take the bit-wise OR of the values in P1 and P2 and
** store the result in P3.
** If either input is NULL, the result is NULL.
*/
...
** Synopsis: r[P3]=r[P2]<<r[P1]
**
** Shift the integer value in P2 to the left by the
...
** Synopsis: r[P3]=r[P2]>>r[P1]
**
** Shift the integer value in P2 to the right by the
** number of bits specified by the integer in P1.
** Store the result in P3.
** If either input is NULL, the result is NULL.
*/
...
**
** Add the constant P2 to the value in P1.
** The result is always an integer.
**
** To force any to be an integer, just add 0.
*/
case OP_AddImm: {            /* in1 */
  pIn1 = &aMem[pOp->p1];
  memAboutToChange(p, pIn1);
...
**
** Force the value in P1 to be an integer.  If the value
...
**
** If P1 holds an integer convert it to a real value.
**
...
**
** Force the value in P1 to be the type defined by P2.
**
** <ul>
** <li> P2=='A' &rarr; BLOB
** <li> P2=='B' &rarr; TEXT
...
**
** Compare the values in P1 and P3.  If reg(P3)==reg(P1) then
** jump to address P2.
**
...
** the content of P3 is less than or equal to the content of
...
**
** This works just like the Lt opcode except that the jump is taken if
** the content of P3 is greater than the content of
** P1.  See the Lt opcode for additional information.
*/
...
**
** This works just like the Lt opcode except that the jump is taken if
** the content of P3 is greater than or equal to the content of
** P1.  See the Lt opcode for additional information.
*/
...
** OPFLAG_PERMUTE bit is clear, then are compared in sequential
** order.
**
...
** Synopsis: r[P3]=(r[P1] || r[P2])
**
** Take the logical OR of the values in P1 and P2 and
** store the answer in P3.
**
...
**
** Interpret the value in P1 as a boolean value.  Store that
** boolean (a 0 or 1) in P2.  Or if the value in P1 is
** NULL, then the P3 is stored in P2.  Invert the answer if P4
** is 1.
**
...
** Synopsis: r[P2]= !r[P1]
**
** Interpret the value in P1 as a boolean value.  Store the
** boolean complement in P2.  If the value in P1 is
...
** Synopsis: r[P2]= ~r[P1]
**
** Interpret the content of P1 as an integer.  Store the
** ones-complement of the P1 value into P2.  If P1 holds
...
** be the that holds that Bloom filter.  See tag-202407032019
...
/* Opcode: If P1 P2 P3 * *
**
** Jump to P2 if the value in P1 is true.  The value
...
**
** Jump to P2 if the value in P1 is False.  The value
...
**
** Jump to P2 if the value in P1 is NULL.
*/
...
** datatype.
**
** If P1 is -1, then P3 is a number and the datatype is taken
...
** is already stored in P3, then this opcode does reliably
...
** P2.  If either registers P1 or P3 are NULL then put
** a NULL in P2.
*/
...
** If it is, then set P3 to NULL and jump immediately to P2.
...
**
** Store in r[P3] the byte offset into the database file that is the
...
**
** The value extracted is stored in P3.
**
  ...
  if( pC->cacheStatus!=p->cacheCtr ){                /*OPTIMIZATION-IF-FALSE*/
    if( pC->nullRow ){
      if( pC->eCurType==CURTYPE_PSEUDO && pC->seekResult>0 ){
        ...
        ** identifies the that holds the record */
      ...
      pC->aRow = static_cast<const u8*>(sqlite3BtreePayloadFetch(pCrsr, &pC->szRow));
...
** forces the type to the Table column type.  This is used
...
case OP_MakeRecord: {
  ...
  ** ------------------------------------------------------------------------
  **
  ** Data(0) is taken from P1.  Data(1) comes from P1+1
  ** and so forth.
  **
  ...
  ** itself. */
  ...
  /* Make sure the output has a buffer large enough to store
  ** the new record. The output (pOp->p3) is not allowed to
  ** be one of the input registers (because the following call to
  ** sqlite3VdbeMemClearAndResize() could clobber the value before it is used).
  */
  if( nByte+nZero<=pOut->szMalloc ){
    /* The output is already large enough to hold the record.
    ** No error checks or buffer enlargement is required */
    pOut->z = pOut->zMalloc;
  }else{
    /* Need to make sure that the output is not too big and then enlarge
    ** the output to hold the full result */
  ...
  if( p1==SAVEPOINT_BEGIN ){
    if( db->nVdbeWrite>0 ){
      ...
      ** that the db->aVTrans[] array is empty.  */
      ...
      pNew = static_cast<Savepoint*>(sqlite3DbMallocRawNN(db, sizeof(Savepoint)+nName+1));
      if( pNew ){
...
**
** Read cookie number P3 from database P1 and write it into P2.
...
** page is P2 (or whose root page is held in P2 if the
...
** <li>  <b>0x10 OPFLAG_P2ISREG</b>: Use the content of P2
...
case OP_OpenEphemeral: {     /* ncycle */
  ...
  assert( pOp->p2>=0 );
  if( pOp->p3>0 ){
    /* Make reg[P3] into a value that can be used as the data
...
** P2.  In other words, cursor P1 becomes an alias for the
** MEM_Blob content contained in P2.
**
...
** use the value in P3 as the key.  If cursor P1 refers
...
**
** If cursor P1 refers to an SQL table (B-Tree that uses integer keys),
** use the value in P3 as a key. If cursor P1 refers
** to an SQL index, then P3 is the first in an array of P4 registers
** that are used as an unpacked index key.
**
** Reposition cursor P1 so that it points to the smallest entry that
...
** Synopsis: key=r[P3@P4]
**
** If P4==0 then P3 holds a blob constructed by MakeRecord.  If
** P4>0 then P3 is the first of P4 registers that form an unpacked
** record.
**
...
** keys).  If P3 does not contain an integer or if P1 does not
...
** the P3 must be guaranteed to contain an integer value.  With this
** opcode, P3 might not contain an integer.
**
...
** P3 to contain a non-integer value, in which case the jump is
...
** Write the sequence number into P2.
...
** written to P2.
**
** If P3>0 then P3 is a in the root frame of this VDBE that holds
** the largest previously generated record number. No new record numbers are
** allowed to be less than this value. When this value reaches its maximum,
** an SQLITE_FULL error is generated. The P3 is updated with the '
...
** number P2. The key is stored in P3. The key must
** be a MEM_Int.
**
...
** and P2 becomes ephemeral.  If the cursor is changed, the
** value of P2 will then change.  Make sure this does not
** cause any problems.)
**
...
** tables, P3 contains the rowid to use with the new record in
...
** record blob in P3 against a prefix of the entry that
...
** Synopsis: r[P2]=data
**
** Write into P2 the current sorter data for sorter cursor P1.
** Then clear the column header cache on cursor P3.
**
** This opcode is normally used to move a record out of the sorter and into
** a that is the source for a pseudo-table cursor created using
...
** Synopsis: r[P2]=data
**
** Write into P2 the complete row content for the row at
** which cursor P1 is currently pointing.
** There is no interpretation of the data. 
** It is just copied onto the P2 exactly as
...
** will be invalidated as soon as the cursor moves - including
** moves caused by other cursors that "save" the current cursors
** position in order that they can write to the same table.  If P3==0
** then a copy of the data is made into memory.  P3!=0 is faster, but
** P3==0 is safer.
**
** If P3!=0 then the content of the P2 is unsuitable for use
** in OP_Result and any OP_Result will invalidate the P2 content.
** The P2 content is invalidated by opcodes like OP_Function or
...
**
** Store in P2 an integer which is the key of the table entry that
...
**
** The content of P3 registers starting at P2 form
...
** Synopsis: r[P2]=rowid
**
** Write into P2 an integer which is the last entry in the record at
...
** Synopsis: key=r[P3@P4]
**
** The P4 values beginning with P3 form an unpacked index
...
** is stored in P2. If no page movement was required (because the
** table being dropped was already the last one in the database) then a
** zero is stored in P2.  If AUTOVACUUM is disabled then a zero
** is stored in P2.
**
...
** than zero, then the value stored in P3 is also incremented
...
** The root page number of the new b-tree is stored in P2.
*/
...
** (P1+1) the text of an error message describing any problems.
** If no problems are found, store a NULL in (P1+1).
**
** The (P1) contains one less than the maximum number of allowed
...
**
** Insert the integer value held by P2 into a RowSet object
** held in P1.
**
...
**
** Register P3 is assumed to hold a 64-bit integer value. If P1
** contains a RowSet object and that RowSet object contains
** the value held in P3, jump to P2. Otherwise, insert the
...
case OP_Program: {        /* jump0 */
  ...
  ** is already allocated. Otherwise, it must be initialized.  */
  if( (pRt->flags&MEM_Blob)==0 ){
    ...
    */
    ...
    pFrame = static_cast<VdbeFrame*>(sqlite3DbMallocZero(db, nByte));
    if( !pFrame ){
      goto no_mem;
    }
  ...
  ** try to reuse values from the first use. */
  {
    int i;
    for(i=0; i<p->nMem; i++){
...
**
** P1 is a in the root frame of this VM (the root frame is
** different from the current frame if this instruction is being executed
** within a sub-program). Set the value of P1 to the maximum of
** its current value and the value in P2.
**
...
** If the value of P1 is 1 or greater, subtract P3 from the
** value in P1 and jump to P2.
**
** If the initial value of P1 is less than 1, then the
...
**
** Register P1 must contain an integer.  If the content of P1 is
** initially greater than zero, then decrement the value in P1.
** If it is non-zero (negative or positive) and then also jump to P2. 
** If P1 is initially zero, leave it unchanged and fall through.
*/
...
** accumulator.
**
** The P5 arguments are taken from P2 and its
** successors.
*/
...
case OP_AggStep: {
  ...
  ** the accumulator, instead of allocating one here. */
  ...
  pCtx = static_cast<sqlite3_context*>(sqlite3DbMallocRawNN(db, nAlloc + sizeof(Mem)));
...
case OP_AggStep1: {
  ...
  /* If this function is inside of a trigger, the array in aMem[]
  ** might change from one evaluation to the next.  The next block of code
  ** checks to see if the array has changed, and if so it
...
**
** Invoke the xValue() function and store the result in P3.
**
** P2 is the number of arguments that the step function takes and
** P4 is a pointer to the FuncDef for this function.  The P2
** argument is not used by this opcode.  It is only there to disambiguate
...
**
** Write a string containing the final journal-mode to P2.
*/
...
**
** If P2 is not zero, then it is a holding a string which is
...
**
** P2 is a that holds the name of a virtual table in database
...
**
** Set P2 to be a pointer to a ValueList object for cursor P1
** with cache P3 and output P3+1.  This ValueList object
...
case OP_VInitIn: {        /* out2, ncycle */
  ...
  pC = p->apCsr[pOp->p1];
  pRhs = static_cast<ValueList*>(sqlite3_malloc64( sizeof(*pRhs) ));
...
**
** Store in P3 the value of the P2-th column of
...
** in P1 is passed as the zName argument to the xRename method.
*/
case OP_VRename: {
  sqlite3_vtab *pVtab;
  Mem *pName;
...
** invocation. The value in (P3+P2-1) corresponds to the
...
**
** Store the maximum page count after the change in P2.
*/
...
** from P2 and successors.  The number of arguments is in
** the sqlite3_context object that P4 points to.
** The result of the function is stored
** in P3.  Register P3 must not be one of the function inputs.
**
...
**
** Extract the subtype value from P1 and write that subtype
** into P2.  If P1 has no subtype, then P1 gets a NULL.
*/
...
**
** Set the subtype value of P2 to the integer from P1.
...
** bloom filter hosted by P1.  If it is not present then
...
** except if bit ii of P3 set, then do not release P1+ii.
** In other words, P3 is a mask of registers to preserve.
**
** Releasing a clears the Mem.pScopyFrom pointer.  That means
** that if the content of the released was set using OP_SCopy,
** a change to the value of the source for the OP_SCopy will no longer
** generate an assertion fault in sqlite3VdbeMemAboutToChange().
**
** If P5 is set, then all released registers have their type set
** to MEM_Undefined so that any subsequent attempt to read the released
** (before it is reinitialized) will generate an assertion fault.
**
