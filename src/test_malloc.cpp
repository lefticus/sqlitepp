...
*/
int sqlite3TestHexToBin(const unsigned char *, int, unsigned char *);
void sqlite3TestBinToHex(unsigned char*,int);
...
static int SQLITE_TCLAPI test_memget(
  ...
  while( size>0 ){
    ...
    zBin += n;
    size -= n;
    sqlite3TestBinToHex((unsigned char*)zHex, n);
