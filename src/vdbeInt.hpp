...
** source code file "vdbe.cpp".  When that file became too big (over
...
/* Opaque type used by code in vdbesort.cpp */
...
struct VdbeCursor {
  ...
  ** For CURTYPE_PSEUDO, seekResult is the holding the record */
