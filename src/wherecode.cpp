...
**
** This file was split off from where.cpp on 2015-06-06 in order to reduce the
** size of where.cpp and make it easier to edit.  This file contains the routines
** that actually generate the bulk of the WHERE loop code.  The original where.cpp
...
** runs faster.
**
** The current value for the constraint is left in  iTarget.
...
static SQLITE_NOINLINE void codeINTerm(
  ...
  int iTarget         /* Attempt to leave results in this */
){
  Expr *pX = pTerm->pExpr;
  ...
  pLevel->u.in.nIn += nEq;
  pLevel->u.in.aInLoop =
     static_cast<struct InLoop*>(sqlite3WhereRealloc(pTerm->pWC->pWInfo,
                         pLevel->u.in.aInLoop,
...
** some other and it is the caller's responsibility to compensate.
**
...
** in consecutive registers and the index of the first is returned.
**
...
**
**   1) allocate a and code an OP_Column instruction to read
...
Bitmask sqlite3WhereCodeOneLoopStart(
  ...
  int iReleaseReg = 0;      /* Temp to free before returning */
  ...
  */
    ...
    ** the u.vtab.idxStr.  NULL it out to prevent a use-after-free */
    ...
    for(j=0; j<nConstraint; j++){
      ...
      if( (pTerm->eOperator & WO_IN)!=0
        ...
        ** was loaded into the same prior to the OP_VFilter, but
  ...
  if( (pLoop->wsFlags & WHERE_IPK)!=0
    ...
    */
    ...
    int regBase;                 /* Base holding constraint values */
    ...
    int regBignull = 0;          /* big-null flag */
    ...
    */
    ...
    if( pLoop->wsFlags & WHERE_TOP_LIMIT ){
      ...
      if( (pRangeEnd->wtFlags & TERM_LIKEOPT)!=0 ){
        ...
        /* iLikeRepCntr actually stores 2x the counter number.  The
  ...
  if( pLoop->wsFlags & WHERE_MULTI_OR ){
    ...
    */
    if( pWInfo->nLevel>1 ){
      ...
      pOrTab = static_cast<SrcList*>(sqlite3DbMallocRawNN(db, SZ_SRCLIST(nNotReady+1)));
    ...
    /* Initialize the rowset to contain NULL. An SQL NULL is
    ...
    ** See tag-20220407a in vdbe.cpp and shell.c */
