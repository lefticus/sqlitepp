...
static int carrayOpen(sqlite3_vtab *p, sqlite3_vtab_cursor **ppCursor){
  carray_cursor *pCur;
  pCur = (carray_cursor*)sqlite3_malloc( sizeof(*pCur) );
...
static int carrayFilter(
  ...
  switch( idxNum ){
    case 1: {
      carray_bind *pBind = (carray_bind*)sqlite3_value_pointer(argv[0], "carray-bind");
      if( pBind==0 ) break;
...
SQLITE_API int sqlite3_carray_bind_v2(
  ...
  pNew = (carray_bind*)sqlite3_malloc64(sizeof(*pNew));
  if( pNew==0 ){
    rc = SQLITE_NOMEM;
    goto carray_bind_error;
  }
...
/*
** Invoke this routine to the carray() function.
*/
