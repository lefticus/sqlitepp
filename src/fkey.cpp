...
/*
** Return an Expr object that refers to a memory corresponding
** to column iCol of table pTab.
**
** regBase is the first of an array of that contains the data
...
** first in an array of (pTab->nCol+1) registers containing the
** rowid of the row being deleted, followed by each of the column values
** of the row being deleted, from left to right. Parameter regNew is passed
** zero in this case.
**
** For an INSERT operation, regOld is passed zero and regNew is passed the
** first of an array of (pTab->nCol+1) registers containing the new
** row data.
**
