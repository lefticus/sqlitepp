...
**
** See also the sqlite3WindowExtraAggFuncDepth() routine in window.cpp
*/
    ...
    */
    case TK_FUNCTION: {
      ...
      if( pDef==0 ){
        ...
        ** where.cpp from replacing the expression with a value read from an
    ...
    for(i=0, pItem=pOrderBy->a; i<pOrderBy->nExpr; i++, pItem++){
      ...
      if( sqlite3ExprIsInteger(pE, &iCol, 0) ){
        ...
        if( iCol==0 ){
          ...
          ** actual expression. This allows the code in alter.cpp to modify
