#!/usr/bin/tclsh
#
# This script constructs the "sqlite3.hpp" header file from the following
# sources:
#
#   1) The src/sqlite.hpp.in source file.  This is the template for sqlite3.hpp.
...
# on the command-line.
#
# This script performs processing on src/sqlite.hpp.in. It:
#
...
if {![file exists $TOP/manifest.tags]} {
  puts stderr "WARNING: building sqlite3.hpp without manifest.tags, which is generated by the SCM."
...
if {$enable_recover} {
  lappend filelist "$TOP/ext/recover/sqlite3recover.hpp"
}
...
foreach file $filelist {
  ...
  while {![eof $in]} {
    ...
    # File sqlite3rtree.hpp contains a line "#include <sqlite3.hpp>". Omit this
    # line when copying sqlite3rtree.hpp into sqlite3.hpp.
    #
    if {[string match {*#include*[<"]sqlite3.hpp[>"]*} $line]} continue
