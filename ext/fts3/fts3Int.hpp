...
#include "sqlite3.hpp"
#include "fts3_tokenizer.hpp"
#include "fts3_hash.hpp"
...
typedef struct Fts3Index Fts3Index;
...
/*
** An index within a fulltext table.
*/
struct Fts3Index {
...
struct Fts3PhraseToken {
  ...
  ** parsed (by code in fts3_expr.cpp). Below this point the variables are
...
struct Fts3Phrase {
  ...
  ** OR condition.  */
  ...
  /* Variables below this point are populated by fts3_expr.cpp when parsing 
...
struct Fts3Expr {
  ...
  /* The following are used by the fts3_snippet.cpp module. */
...
/* fts3_unicode2.cpp (functions generated by parsing unicode text files) */
