...
**
**   (linux)    gcc -fPIC -shared cksumvfs.cpp -o cksumvfs.so
**   (mac)      clang -fPIC -dynamiclib cksumvfs.cpp -o cksumvfs.dylib
**   (windows)  cl cksumvfs.cpp -link -dll -out:cksumvfs.dll
**
