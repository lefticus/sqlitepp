...
** *Nix: gcc -O2 -shared -I$SQDIR $OPTS -fPIC -o base85.so base85.cpp
** OSX: gcc -O2 -dynamiclib -fPIC -I$SQDIR $OPTS -o base85.dylib base85.cpp
** Win32: gcc -O2 -shared -I%SQDIR% %OPTS% -o base85.dll base85.cpp
** Win32: cl /Os -I%SQDIR% %OPTS% base85.cpp -link -dll -out:base85.dll
**
** To build the standalone program, define PP symbol BASE85_STANDALONE. Eg.
** *Nix or OSX: gcc -O2 -DBASE85_STANDALONE base85.cpp -o base85
** Win32: gcc -O2 -DBASE85_STANDALONE -o base85.exe base85.cpp
** Win32: cl /Os /MD -DBASE85_STANDALONE base85.cpp
*/
