...
** *Nix: gcc -O2 -shared -I$SQDIR -fPIC -o base64.so base64.cpp
** OSX: gcc -O2 -dynamiclib -fPIC -I$SQDIR -o base64.dylib base64.cpp
** Win32: gcc -O2 -shared -I%SQDIR% -o base64.dll base64.cpp
** Win32: cl /Os -I%SQDIR% base64.cpp -link -dll -out:base64.dll
*/
