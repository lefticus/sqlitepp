...
static void fts5StructureAddLevel(int *pRc, Fts5Structure **ppStruct){
  ...
  if( *pRc==SQLITE_OK ){
    ...
    pStruct = static_cast<Fts5Structure *>(sqlite3_realloc64(pStruct, nByte));
    if( pStruct ){
...
static void fts5StructureExtendLevel(
  ...
  if( *pRc==SQLITE_OK ){
    ...
    aNew = static_cast<Fts5StructureSegment *>(sqlite3_realloc64(pLvl->aSeg, nByte));
    if( aNew ){
      if( bInsert==0 ){
...
static void fts5SegIterHashInit(
  ...
  if( pTerm==0 || (flags & FTS5INDEX_QUERY_SCAN) ){
    ...
    if( pList ){
      pLeaf = (Fts5Data*)fts5IdxMalloc(p, sizeof(Fts5Data));
      if( pLeaf ){
        pLeaf->p = (u8*)pList;
      }
    }
    ...
    if( iNext==0 ){
      ...
      ** and nIdx accordingly.  */
      if( pLeaf->nn>pLeaf->szLeaf ){
        ...
        aIdx = static_cast<u8 *>(sqlite3Fts5MallocZero(&p->rc, (pLeaf->nn-pLeaf->szLeaf)+2));
        if( aIdx==0 ) break;
...
static void fts5DoSecureDelete(
  ...
  nIdx = nPg-iPgIdx;
  aIdx = static_cast<u8 *>(sqlite3Fts5MallocZero(&p->rc, ((i64)nIdx)+16));
  if( p->rc ) return;
...
static void fts5SetupPrefixIter(
  ...
  if( p->rc==SQLITE_OK ){
    ...
    ** main term index here.  */
    ...
    pData = (Fts5Data*)fts5IdxMalloc(p, sizeof(*pData)
...
static void fts5DecodeFunction(
  ...
  ** buffer overreads even if the record is corrupt.  */
  ...
  aBlob = static_cast<const u8 *>(sqlite3_value_blob(apVal[1]));
...
static int fts5structConnectMethod(
  ...
  if( rc==SQLITE_OK ){
    pNew = static_cast<Fts5StructVtab *>(sqlite3Fts5MallocZero(&rc, sizeof(*pNew)));
  }
...
static int fts5structOpenMethod(sqlite3_vtab *p, sqlite3_vtab_cursor **ppCsr){
  ...
  pNew = static_cast<Fts5StructVcsr *>(sqlite3Fts5MallocZero(&rc, sizeof(*pNew)));
