...
** field that occurs at the start of each leaf page (see fts5_index.cpp). */
#define FTS5_MAX_TOKEN_SIZE 32768

/*
** Maximum number of prefix indexes on single FTS5 table. This must be
** less than 32. If it is set to anything large than that, an #error
** directive in fts5_index.cpp will cause the build to fail.
*/
...
**
** This object is used by fts5_expr.cpp and fts5_index.cpp.
*/
struct Fts5Colset {
  int nCol;
  int aiCol[FLEXARRAY];
...
/**************************************************************************
** Interface to code in fts5_config.cpp. fts5_config.cpp contains contains code
...
**
** pzErrmsg:
**   This exists in order to allow the fts5_index.cpp module to return a 
...
/*
** End of interface to code in fts5_config.cpp.
**************************************************************************/

/**************************************************************************
** Interface to code in fts5_buffer.cpp.
*/
...
/*
** End of interface to code in fts5_buffer.cpp.
**************************************************************************/

/**************************************************************************
** Interface to code in fts5_index.cpp. fts5_index.cpp contains contains code
...
/* The following are used internally by the fts5_index.cpp module. They are
...
/*
** End of interface to code in fts5_index.cpp.
**************************************************************************/

/**************************************************************************
** Interface to code in fts5_varint.cpp. 
*/
...
/*
** End of interface to code in fts5_varint.cpp.
**************************************************************************/


/**************************************************************************
** Interface to code in fts5_main.cpp. 
*/
...
/**************************************************************************
** Interface to code in fts5_hash.cpp. 
*/
...
/*
** End of interface to code in fts5_hash.cpp.
**************************************************************************/

/**************************************************************************
** Interface to code in fts5_storage.cpp. fts5_storage.cpp contains contains 
...
/*
** End of interface to code in fts5_storage.cpp.
**************************************************************************/


/**************************************************************************
** Interface to code in fts5_expr.cpp. 
*/
...
/*******************************************
** The fts5_expr.cpp API above this point is used by the other hand-written
...
/*
** End of interface to code in fts5_expr.cpp.
**************************************************************************/



/**************************************************************************
** Interface to code in fts5_aux.cpp. 
*/

int sqlite3Fts5AuxInit(fts5_api*);
/*
** End of interface to code in fts5_aux.cpp.
**************************************************************************/
...
/**************************************************************************
** Interface to code in fts5_vocab.cpp. 
*/

int sqlite3Fts5VocabInit(Fts5Global*, sqlite3*);

/*
** End of interface to code in fts5_vocab.cpp.
**************************************************************************/


/**************************************************************************
** Interface to automatically generated code in fts5_unicode2.cpp. 
*/
...
/*
** End of interface to code in fts5_unicode2.cpp.
**************************************************************************/
