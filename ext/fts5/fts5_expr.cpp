...
int sqlite3Fts5ExprNew(
  ...
  ** implicit column-filter.  */
  ...
  if( sParse.rc==SQLITE_OK ){
    *ppNew = pNew = static_cast<Fts5Expr *>(sqlite3_malloc64(sizeof(Fts5Expr)));
    if( pNew==0 ){
...
static int fts5ExprNodeTest_TERM(
  ...
  ** fts5_index.cpp iterator object. This is much faster than synthesizing 
...
Fts5ExprNearset *sqlite3Fts5ParseNearset(
  ...
  if( pParse->rc==SQLITE_OK ){
    if( pNear==0 ){
      ...
      pRet = static_cast<Fts5ExprNearset *>(sqlite3_malloc64(nByte));
      if( pRet==0 ){
  ...
  if( rc || (rc = sCtx.rc) ){
    ...
    if( sCtx.pPhrase==0 ){
      ...
      ** no token characters at all. (e.g ... MATCH '""'). */
      sCtx.pPhrase = static_cast<Fts5ExprPhrase *>(sqlite3Fts5MallocZero(&pParse->rc, SZ_FTS5EXPRPHRASE(1)));
...
int sqlite3Fts5ExprClonePhrase(
  ...
  if( rc==SQLITE_OK ){
    if( pOrig->nTerm ){
      ...
      /* This happens when parsing a token or quoted phrase that contains
      ** no token characters at all. (e.g ... MATCH '""'). */
      sCtx.pPhrase = static_cast<Fts5ExprPhrase *>(sqlite3Fts5MallocZero(&rc, SZ_FTS5EXPRPHRASE(1)));
    }
  }
...
static Fts5Colset *fts5ParseColset(
  ...
  pNew = static_cast<Fts5Colset *>(sqlite3_realloc64(p, SZ_FTS5COLSET(nCol+1)));
  if( pNew==0 ){
    pParse->rc = SQLITE_NOMEM;
  }else{
...
static char *fts5ExprTermPrint(Fts5ExprTerm *pTerm){
  ...
  zQuoted = static_cast<char *>(sqlite3_malloc64(nByte));
...
Fts5PoslistPopulator *sqlite3Fts5ExprClearPoslists(Fts5Expr *pExpr, int bLive){
  ...
  pRet = static_cast<Fts5PoslistPopulator *>(sqlite3_malloc64(sizeof(Fts5PoslistPopulator)*pExpr->nPhrase));
  if( pRet ){
    int i;
