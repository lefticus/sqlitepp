...
static int fts5ConfigParseSpecial(
  ...
  if( sqlite3_strnicmp("prefix", zCmd, nCmd)==0 ){
    ...
    if( pConfig->aPrefix==0 ){
      pConfig->aPrefix = static_cast<int *>(sqlite3Fts5MallocZero(&rc, nByte));
      if( rc ) return rc;
    }
  ...
  if( sqlite3_strnicmp("tokenize", zCmd, nCmd)==0 ){
    ...
    char **azArg = static_cast<char **>(sqlite3Fts5MallocZero(&rc, (sizeof(char*) + 2) * nArg));
...
static const char *fts5ConfigGobbleWord(
  ...
  char *zOut = static_cast<char *>(sqlite3_malloc64(nIn+1));
...
int sqlite3Fts5ConfigParseRank(
  ...
  *pzRankArgs = 0;
  ...
  if( p==0 ){
    ...
    if( p ){
      zRank = static_cast<char *>(sqlite3Fts5MallocZero(&rc, 1 + p - pRank));
    ...
    if( rc==SQLITE_OK ){
      ...
      if( *p!=')' ){
        ...
        if( p==0 ){
          ...
          zRankArgs = static_cast<char *>(sqlite3Fts5MallocZero(&rc, 1 + p - pArgs));
